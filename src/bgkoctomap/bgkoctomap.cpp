...
// #endif
    ...
    void BGKOctoMap::insert_pointcloud(const PCLPointCloud& cloud, const PCLPointCloud& origin, float ds_resolution,
        float free_res, float max_range) {
...
// #endif
    ...
    void BGKOctoMap::get_training_data(const PCLPointCloud& cloud, const PCLPointCloud& origin_cloud, float ds_resolution,
        float free_resolution, float max_range, GPPointCloud& xy) const {
